    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('kepseksuper.store')}}" enctype="multipart/form-data">
                        @csrf
                    ...
                    <a type="submit" class="btn btn-danger float-right" href="{{route('kepseksuper.index')}}">
                        {{ __('Kembali') }}
                    </a>

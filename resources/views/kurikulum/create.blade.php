            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="is_admin" class="col-md-4 col-form-label text-md-end">{{ __('Supervisor') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="supervisor" class="col-md-4 col-form-label text-md-end">{{ __('Jabatan') }}</label>
